...
|---|---|
| Date | 2026-08-03 |
| Supersedes current-state interpretation | §7.9の`ARCH-C135 open-blocker／not_adopted`は同follow-up時点の記録として保持し、current Architecture状態は本節と§8のClosure Registerで上書きする |
